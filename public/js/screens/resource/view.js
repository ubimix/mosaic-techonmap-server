define([ 'Backbone', 'jQueryToast', 'core/viewManager', 'BootstrapModal', 'utils', 'text!./view.html' ], function(Backbone,
        jQueryToast, viewManager, BootstrapModal, Utils, template) {
